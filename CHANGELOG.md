...
## [1.5.1](https://github.com/Pulsenote/pulsenote-node/compare/1.5.0...1.5.1) (2026-09-24)


### Chores

* release 1.5.1 ([70a78b3](https://github.com/Pulsenote/pulsenote-node/commit/70a78b335384b313b07240a6bb2517216e405b4c))
...
* **domains:** expose update() for the per-domain sender identity ([#18](https://github.com/Pulsenote/pulsenote-node/issues/18)) ([06c6224](https://github.com/Pulsenote/pulsenote-node/commit/06c62247bc229b76e8f0662672f1b2bc44cdc469))
...
[Unreleased]: https://github.com/Pulsenote/pulsenote-node/compare/1.1.0...HEAD
[1.1.0]: https://github.com/Pulsenote/pulsenote-node/compare/1.0.0...1.1.0
